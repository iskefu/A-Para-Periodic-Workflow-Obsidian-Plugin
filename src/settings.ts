...
export class SampleSettingTab extends PluginSettingTab {
	...
	async display(): Promise<void> {
        ...
        containerEl.createEl('h5', { text: 'PARA 文件夹地址以及文件模板名称设置' });
		...
		containerEl.createEl('h5', {text: await getMessage('PeriodicNotesFolderAndTemplateNameSettings')});
		...
		.addText(text => text
			...
			containerEl.createEl('h5', {text:await getMessage('AddYAMLAttributes')});
...
//			//.setDesc(await getMessage('SetYAMLAttributeValueDateFormatForDocument'))
			...
			containerEl.createEl('h5', {text: await getMessage("DeleteYAMLAttributes")});
			new Setting(this.containerEl)
...
//			//.setDesc(await getMessage('SetYAMLAttributeValueDateFormatForDocument'))
			...
			containerEl.createEl('h5', {text: await getMessage("SetTaskDateFormat")});
			new Setting(containerEl)
